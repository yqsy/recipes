...
/*
Package service_protocol is a reverse proxy.
...
func request_ServiceA_Echo_0(ctx context.Context, marshaler runtime.Marshaler, client ServiceAClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterServiceAHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ServiceAClient) error {
	...
	mux.Handle("POST", pattern_ServiceA_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ServiceA_Echo_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_ServiceA_Echo_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_ServiceA_Echo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "example", "echo"}, ""))
)

var (
	forward_ServiceA_Echo_0 = runtime.ForwardResponseMessage
)
